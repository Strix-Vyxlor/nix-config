...
def get_args():
    ...
    arg.add_argument("-c", "--cursor", default="Vimix-cursors;vimix-cursors;24",
                     help="cursor name, package name and size seperated with ; (default: %(default)s")
    arg.add_argument("-i", "--icons", default="Papirus-Dark;papirus-icon-theme",
                     help="icons name and package name seperated with ; (default: %(default)s")
    arg.add_argument("-b", "--bg-color", default="#131313",
                     help="the background color (default: %(default)s")
    arg.add_argument("-F", "--fg-color", default="#FAFAFA",
                     help="the background color (default: %(default)s")
    arg.add_argument("-l", "--light", action="store_false",
                     help="create a light theme.")
    arg.add_argument("-o", "--output", default="theme.toml",
                     help="create a light theme.")
